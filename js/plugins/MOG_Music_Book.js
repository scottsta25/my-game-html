 ...
 *
 * =============================================================================
 * As imagens correspondentes das músicas devem ser gravadas na pasta
 *
 * /img/musicbook/ 
 *
 * E as imagem devem ter o nome igual ao arquivo de música para aparecerem na 
 * tela.
 * =============================================================================
 * A descrição e o titulo da música devem ser feitas diretamente no arquivo do PLUGIN, 
 * ou seja, você deverá abrir o arquivo atráves do Bloco de notas comum, ou qualquer programa.
 *
 * MOG_Music_Book.js 
 *
 * Este arquivo está na pasta /js/plugins/
 *
 * =============================================================================
 * Para configurar o script escreva estes comentários.
 *
